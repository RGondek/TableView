...
- (void)viewDidLoad {
    ...
    _Appdescricao = [[NSMutableArray alloc]initWithObjects:@"Manter-se em contatos com amigos está mais rápido que nunca. Receba notificações quando seus amigos curtem e comentam publicações.", @"    Junte-se a dois bravos pontos que atravessam tundras artícas, navegam por selvas em fogo e mergulham nas rofundezas do oceano.", @"O Spotify é o melhor para ouvir música no celular ou no tablet. Busque qualquer faixa, artista oou albúm e ouça de graça.", @"O jgo mais doce de todos os tempos. Encare esa saga deliciosamente doce por conta propria ou jogue com os amigos para ver quem consegue mais pontos.", @"O WhatsApp Messenger é um mensageiro para smartphones. Utiliza a sua conexão 3G ou WI-FI para enviar mensagens para seus amigos e família.",@"Shazam é a melhor maneira para identificar música em TV. Em, segundos você saberá o nome de qualquer música ou mais sobre o que estiver assistindo.",nil];
